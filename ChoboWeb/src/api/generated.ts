...
export interface BackupExport { id: string; triggerType: BackupTriggerType; status: BackupRunStatus; backupType: BackupType; sourceClusterId: string; targetId: string; policyId?: string | null; scheduleId?: string | null; manualRequestJson?: string | null; requestedByUserId?: string | null; requestedByName: string; createdAt: string; queuedAt: string; startedAt?: string | null; completedAt: string; error?: string | null; failureReason?: string | null; isPinned: boolean; pinnedAt?: string | null; pinnedByUserId?: string | null; pinnedByName?: string | null; deletionReason?: string | null; deletionRequestedAt?: string | null; deletionStartedAt?: string | null; deletedAt?: string | null; deletionError?: string | null; deletionAttemptCount: number; }
...
export interface BackupPolicyDto { id: string; name: string; sourceClusterId: string; targetId: string; selectorJsonVersion: number; selector: PolicySelector; retention: BackupRetentionDto; failedBackupRetentionMode: FailedBackupRetentionMode; isDeleted: boolean; createdAt: string; updatedAt?: string | null; }
export interface BackupPolicyExport { id: string; name: string; sourceClusterId: string; targetId: string; selectorJsonVersion: number; selector: PolicySelector; retention: BackupRetentionDto; failedBackupRetentionMode: FailedBackupRetentionMode; isDeleted: boolean; createdAt: string; updatedAt?: string | null; deletedAt?: string | null; }
...
export interface BackupScheduleExport { id: string; name: string; policyId: string; backupType: BackupType; cronExpression: string; timeZoneId: string; isEnabled: boolean; missedRunGracePeriod?: string | null; description?: string | null; isDeleted: boolean; createdAt: string; updatedAt?: string | null; deletedAt?: string | null; }
export interface BackupTableDto { id: string; backupId: string; effectiveBackupType: BackupType; parentFullBackupId?: string | null; parentFullBackupTableId?: string | null; database: string; table: string; engine: string; dataBackedUp: boolean; schemaDefinitionId: string; s3Path: string; status: BackupTableStatus; clickHouseOperationId?: string | null; clickHouseStatus?: string | null; startedAt?: string | null; completedAt: string; error?: string | null; shards: BackupTableShardDto[]; }
export interface BackupTableExport { id: string; backupId: string; effectiveBackupType: BackupType; parentFullBackupId?: string | null; parentFullBackupTableId?: string | null; database: string; table: string; engine: string; dataBackedUp: boolean; schemaDefinitionId: string; s3Path: string; status: BackupTableStatus; clickHouseOperationId?: string | null; clickHouseStatus?: string | null; startedAt?: string | null; completedAt: string; error?: string | null; }
export interface BackupTableShardDto { id: string; backupTableId: string; effectiveBackupType: BackupType; parentFullBackupId?: string | null; parentFullBackupTableShardId?: string | null; sourceShardNumber: number; sourceShardName?: string | null; replicaNumber: number; host: string; port: number; useTls: boolean; s3Path: string; status: BackupTableStatus; clickHouseOperationId?: string | null; clickHouseStatus?: string | null; startedAt?: string | null; completedAt: string; error?: string | null; }
...
export interface UpsertPolicyRequest { name: string; sourceClusterId: string; targetId: string; selector: PolicySelector; retention: BackupRetentionDto; failedBackupRetentionMode: FailedBackupRetentionMode; }
