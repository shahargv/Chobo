...
export type BackupCompressionMethod = "Store" | "Deflate" | "Bzip2" | "Lzma" | "Zstd" | "Xz";
export type BackupContentMode = "SchemaAndData" | "SchemaOnly";
export interface BackupDto { id: string; triggerType: BackupTriggerType; status: BackupRunStatus; backupType: BackupType; contentMode: BackupContentMode; sourceClusterId: string; targetId: string; policyId?: string | null; scheduleId?: string | null; requestedByUserId?: string | null; requestedByName: string; manualRequestJson?: string | null; storageRootPath?: string | null; createdAt: string; startedAt?: string | null; endedAt?: string | null; error?: string | null; failureReason?: string | null; isPinned: boolean; pinnedAt?: string | null; pinnedByUserId?: string | null; pinnedByName?: string | null; deletionReason?: string | null; deletionRequestedAt?: string | null; deletionStartedAt?: string | null; deletedAt?: string | null; deletionError?: string | null; deletionAttemptCount: number; tableCount: number; backupSizeBytes: number; clickHouseBackupSettings?: Record<string, ClickHouseSettingValue> | null; relatedFullBackupIds: string[]; childBackupIds: string[]; tables: BackupTableDto[]; encryptionState: BackupEncryptionState; compressionMethod?: BackupCompressionMethod | null; compressionLevel?: number | null; }
export type BackupEncryptionState = "Unencrypted" | "EncryptedKeyAvailable" | "EncryptedMissingKey";
export interface BackupExport { id: string; triggerType: BackupTriggerType; status: BackupRunStatus; backupType: BackupType; contentMode: BackupContentMode; sourceClusterId: string; targetId: string; policyId?: string | null; scheduleId?: string | null; manualRequestJson?: string | null; storageRootPath?: string | null; requestedByUserId?: string | null; requestedByName: string; createdAt: string; queuedAt: string; startedAt?: string | null; completedAt: string; error?: string | null; failureReason?: string | null; isPinned: boolean; pinnedAt?: string | null; pinnedByUserId?: string | null; pinnedByName?: string | null; deletionReason?: string | null; deletionRequestedAt?: string | null; deletionStartedAt?: string | null; deletedAt?: string | null; deletionError?: string | null; deletionAttemptCount: number; clickHouseBackupSettings?: Record<string, ClickHouseSettingValue> | null; }
export interface BackupGarbageCollectionEvaluationDto { backupId: string; eligibleForDeletion: boolean; text: string; reasons: BackupGarbageCollectionReasonDto[]; evaluatedAt: string; }
export type BackupGarbageCollectionReason = "EligibleForDeletion" | "BackupAlreadyDeleted" | "DeletionAlreadyRequested" | "BackupInProgress" | "BackupStatusNotEligible" | "PolicyMissing" | "PolicyDeleted" | "RetentionNotConfigured" | "RetentionPeriodNotElapsed" | "ProtectedByMinimumBackupCount" | "ProtectedByMinimumFullBackupCount" | "BackupPinned" | "ActiveDependentBackups";
export interface BackupGarbageCollectionReasonDto { reason: BackupGarbageCollectionReason; text: string; relatedBackupIds: string[]; }
...
export interface BackupTableShardDto { id: string; backupTableId: string; effectiveBackupType: BackupType; parentFullBackupId?: string | null; parentFullBackupTableShardId?: string | null; sourceShardNumber: number; sourceShardName?: string | null; replicaNumber: number; host: string; port: number; useTls: boolean; storagePath: string; backupSizeBytes: number; status: BackupTableStatus; clickHouseOperationId?: string | null; clickHouseStatus?: string | null; startedAt?: string | null; completedAt: string; error?: string | null; isPasswordProtected: boolean; passwordKeyId?: string | null; passwordKeyAvailable?: boolean | null; }
export interface BackupTableShardExport { id: string; backupTableId: string; effectiveBackupType: BackupType; parentFullBackupId?: string | null; parentFullBackupTableShardId?: string | null; sourceShardNumber: number; sourceShardName?: string | null; replicaNumber: number; host: string; port: number; useTls: boolean; storagePath: string; backupSizeBytes: number; status: BackupTableStatus; clickHouseOperationId?: string | null; clickHouseStatus?: string | null; startedAt?: string | null; completedAt: string; error?: string | null; s3Path?: string; encryptedBackupPassword?: string | null; encryptedBackupPasswordKeyId?: string | null; }
...
export interface ImportResultDto { succeeded: boolean; importedPolicies: number; importedBackups: number; importedRestores: number; affectedPolicyCount: number; affectedBackupShardCount: number; missingOrInvalidAesKeyIds: string[]; warning?: string | null; }
...
export interface UpsertPolicyRequest { name: string; sourceClusterId: string; targetId: string; selector: PolicySelector; contentMode: BackupContentMode; retention: BackupRetentionDto; failedBackupRetentionMode: FailedBackupRetentionMode; clickHouseBackupSettings?: Record<string, ClickHouseSettingValue> | null; clickHouseRestoreSettings?: Record<string, ClickHouseSettingValue> | null; maxAgeHoursForBaseBackup?: number | null; passwordMode: BackupPasswordMode; backupPassword?: string | null; compressionMethod?: BackupCompressionMethod | null; compressionLevel?: number | null; }
...
export const openApiSchemaNames = [
  ...
  "BackupGarbageCollectionReason",
  "BackupGarbageCollectionReasonDto",
