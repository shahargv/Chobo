...
public static class ChoboConfiguration
{
    ...
    private static void AddChoboEnvironmentAliases(IConfigurationBuilder configuration)
    {
        ...
        AddAlias(values, "CHOBO_SQLITE_JOURNAL_MODE", "Chobo:Sqlite:JournalMode");
        AddAlias(values, "CHOBO_SQLITE_SYNCHRONOUS", "Chobo:Sqlite:Synchronous");
        AddAlias(values, "CHOBO_SQLITE_BUSY_TIMEOUT", "Chobo:Sqlite:BusyTimeout");
        AddAlias(values, "CHOBO_SQLITE_WAL_AUTO_CHECKPOINT", "Chobo:Sqlite:WalAutoCheckpoint");
        ...
        AddAlias(values, "CHOBO_METRICS_INCLUDE_TABLE_SHARD_METRICS", "Chobo:Metrics:IncludeTableShardMetrics");
