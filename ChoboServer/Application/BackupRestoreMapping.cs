...
internal static class BackupRestoreMapping
{
    ...
    public static RestoreTableShardDto ToDto(RestoreTableShardEntity x) =>
        new(
            ...
            x.BackupTableShard?.BackupTable?.BackupId ?? Guid.Empty,
            x.BackupTableShard?.BackupTableId ?? Guid.Empty,
            x.BackupTableShard?.BackupTable?.Backup?.BackupType ?? BackupType.Full,
            x.BackupTableShard?.BackupTable?.Backup?.CreatedAt ?? DateTimeOffset.UnixEpoch,
            x.SourceShardNumber,
            x.TargetShardNumber,
            x.TargetShardName,
