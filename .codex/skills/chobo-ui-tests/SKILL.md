...
- `restore`: backup plus restore wizard, restore details, and restored-row verification.
...
- `full`: default full journey through bootstrap, setup, policy, schedule, backup, restore, details, logs, and audit.
