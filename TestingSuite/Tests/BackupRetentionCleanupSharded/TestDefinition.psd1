@{
    ...
    Action = @(
        ...
        @{
            ...
            ExpectJson = @(
                @{ Path = '$'; ContainsObject = @{ action = 'delete-requested'; entityType = 'backup'; entityId = '{backup.id}' } }
                @{ Path = '$'; ContainsObject = @{ action = 'backup-cleanup-succeeded'; entityType = 'backup'; entityId = '{backup.id}' } }
            )
        }
    )
