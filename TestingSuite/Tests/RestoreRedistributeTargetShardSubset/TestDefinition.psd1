@{
    ...
    Verify = @(
        ...
        @{ Name = 'verify-atomic-target-shard-three-has-table'; Type = 'Csv'; Resource = 'restore'; Host = 'clickhouse-restore-s3-r1'; Path = 'Sql/select-unused-target-table-count.sql'; Expected = 'Expected/zero-count.csv'; Actual = 'atomic-target-shard-three-table-count.csv' }
